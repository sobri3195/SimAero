...
const AmbulancePage = () => {
  ...
  const tabs = [
    ...
    { id: 'tab2', label: 'Tarif', icon: FileText },
    { id: 'tab3', label: 'BMHP', icon: FileText },
    { id: 'tab4', label: 'Laporan', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Ambulans', path: '/AmbulancePage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Ambulans"
        subtitle="Layanan Ambulans dan Transportasi Medis"
