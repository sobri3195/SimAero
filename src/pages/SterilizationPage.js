...
const SterilizationPage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Penerimaan', icon: FileText },
    { id: 'tab2', label: 'Pencucian', icon: FileText },
    { id: 'tab3', label: 'Penyimpanan', icon: FileText },
    { id: 'tab4', label: 'Pengemasan', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Sterilisasi', path: '/SterilizationPage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Sterilisasi"
        subtitle="Layanan Sterilisasi Alat Medis"
