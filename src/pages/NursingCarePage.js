...
const NursingCarePage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Implementasi', icon: FileText },
    { id: 'tab2', label: 'Rencana', icon: FileText },
    { id: 'tab3', label: 'Evaluasi', icon: FileText },
    { id: 'tab4', label: 'Discharge Planning', icon: FileText },
    { id: 'tab5', label: 'Riwayat Obat', icon: FileText },
    { id: 'tab6', label: 'NIC', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Asuhan Keperawatan', path: '/NursingCarePage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        ...
        subtitle="Dokumentasi Asuhan Keperawatan"
