...
const SMSGatewayPage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Pesan Keluar', icon: FileText },
    { id: 'tab2', label: 'Pesan Terkirim', icon: FileText },
    { id: 'tab3', label: 'Pesan Masuk', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'SMS Gateway & Email', path: '/SMSGatewayPage' }
  ];

  return (
    <div className="p-6">
      <PageHeader
        title="SMS Gateway & Email"
        subtitle="Komunikasi dan Notifikasi"
