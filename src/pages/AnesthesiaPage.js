...
const AnesthesiaPage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Pra Anestesi', icon: FileText },
    { id: 'tab2', label: 'Intra Anestesi', icon: FileText },
    { id: 'tab3', label: 'Post Anestesi', icon: FileText },
    { id: 'tab4', label: 'Info Pasien', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Anestesi', path: '/AnesthesiaPage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Anestesi"
        subtitle="Layanan Anestesi dan Operasi"
