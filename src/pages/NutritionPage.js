...
const NutritionPage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Makanan', icon: FileText },
    { id: 'tab2', label: 'Menu Diet', icon: FileText },
    { id: 'tab3', label: 'Konsultasi', icon: FileText },
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Gizi"
        subtitle="Layanan Gizi dan Diet"
