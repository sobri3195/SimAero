...
const BloodBankServicePage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Donor', icon: FileText },
    { id: 'tab2', label: 'Distribusi', icon: FileText },
    { id: 'tab3', label: 'Penyimpanan', icon: FileText },
    { id: 'tab4', label: 'Stok', icon: FileText },
    { id: 'tab5', label: 'BMHP', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Bank Darah', path: '/BloodBankServicePage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Bank Darah"
        subtitle="Layanan Bank Darah dan Donor"
...
export default BloodBankServicePage;
