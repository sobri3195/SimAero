...
const MortuaryPage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Mobil', icon: FileText },
    { id: 'tab2', label: 'Pendaftaran', icon: FileText },
    { id: 'tab3', label: 'Tindakan', icon: FileText },
    { id: 'tab4', label: 'Surat Meninggal', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Pemulasaran Jenazah', path: '/MortuaryPage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        ...
        subtitle="Layanan Pemulasaran dan Manajemen Jenazah"
