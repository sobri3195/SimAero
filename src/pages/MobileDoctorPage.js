...
const MobileDoctorPage = () => {
  ...
  const tabs = [
    ...
    { id: 'tab2', label: 'Jadwal', icon: FileText },
    { id: 'tab3', label: 'List Pendaftaran', icon: FileText },
    { id: 'tab4', label: 'List Pasien', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Mobile Doctor', path: '/MobileDoctorPage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Mobile Doctor"
        subtitle="Aplikasi Mobile untuk Dokter"
