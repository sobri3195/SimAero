...
const FinancePage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Kas', icon: FileText },
    { id: 'tab2', label: 'Bank', icon: FileText },
    { id: 'tab3', label: 'Transfer', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Keuangan', path: '/FinancePage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Keuangan"
        subtitle="Manajemen Keuangan dan Kas"
