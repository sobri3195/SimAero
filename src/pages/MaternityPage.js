...
const MaternityPage = () => {
  ...
  const tabs = [
    { id: 'tab1', label: 'Abortus', icon: FileText },
    { id: 'tab2', label: 'Persalinan', icon: FileText },
    { id: 'tab3', label: 'Pemeriksaan', icon: FileText },
    { id: 'tab4', label: 'Perawatan Bayi', icon: FileText },
  ];
  ...
  const breadcrumbItems = [
    { label: 'Modul', path: '#' },
    { label: 'Persalinan', path: '/MaternityPage' }
  ];
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Persalinan"
        subtitle="Layanan Persalinan dan Perawatan Bayi"
